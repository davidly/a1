...
Notes:
  - Performance on physical CP/M machines isn't great. Compared to a physical 1.022727 Mhz 6502:
   ...
   - Using m6.asm when run on a 2Mhz 8080, A1 is 82.1 times slower.
   - Using m6.asm when run on a 4Mhz Z80, A1 is 41.5 times slower. This is typical for interpreter emulators across platforms.
