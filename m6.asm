...
;    uint8_t op;
        bss     .op1,1    ; 1st byte after the current opcode. stored in register e also
        bss     .op2,1    ; 2nd "
...
.gothl_loop          ; assumes hl has cpu.pc
        call get_hmem_
        mov a, m
        mov c, a     ; ==> the current opcode is in register c
